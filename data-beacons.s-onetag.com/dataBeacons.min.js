    ...
    window.__underground.beacons = {
        ...
        LiveRamp: {
            execute: function() {
                if (window.sovrn) {
                    var a =
                        window.sovrn.ads.createiFrame("_rlcdn", 1, 1);
        ...
        BlueCavaPixel: {
            execute: function(a) {
                ...
                (new Image).src = "https://sync.graph.bluecava.com/ds.png?p=95b767e8-0bec-4fdb-a4d3-bc8ce01a08cd&segment=66afeee89497e411a7020050569b1b56&uid=" +
                    a + "&sovrnrnd=" + b
            },
            config: {
                volume: 100
        ...
        Drawbridge: {
            execute: function(a) {
                var b = Math.floor(1E5 * Math.random()),
                    c = document.referrer;
                (new Image).src = "https://p.adsymptotic.com/d/px/?_pid=15697&_psign=0a885fb568701ac53478d88866a10345&_pu" + c + "&_puuid=" + a + "&_redirect=https%3A%2F%2Fce.lijit.com%2Fmerge%3Fpid%3D5014%263pid%3D${UUID}&_rand=" +
                    b
            },
            config: {
                volume: 100
        ...
        LiveIntent_Rev_Share: {
            execute: function(a) {
                ...
                c.src = "https://i.liadm.com/s/57333?bidder_id=204553&bidder_uuid=" +
                    a + "&rnd=" + b;
        ...
        LiveIntent_Hash: {
            execute: function(a) {
                var b = Math.floor(1E5 * Math.random()),
                    c = document.createElement("img");
                c.src = "https://i.liadm.com/s/59074?bidder_id=204553&bidder_uuid=" + a + "&rnd=" + b;
                document.body.appendChild(c)
            },
            config: {
                volume: 100
        ...
        IntentIQ_2: {
            execute: function() {
                var a = Math.floor(1E5 * Math.random()),
                    b = document.createElement("iframe");
                b.src = "https://api.intentiq.com/profiles_engine/ProfilesEngineServlet?at=15&eid=19&aw=468&ah=60&pagePos=1&vip=true&secure=1&sub_eid=11304&maxed=1&rnd=" +
                    a;
                b.width = 0;
                b.height = 0;
                b.style = "display:none";
        ...
        WeboramaGDPR: {
            execute: function(a, b, c) {
                c && gdprString && (c = document.createElement("img"),
                    c.src = "https://dx.frontend.weborama.com/collect?dsp_id=5&eid=" + a + "&gdpr=1&gdpr_consent=" + b, document.getElementsByTagName("head")[0].appendChild(c))
            },
            config: {
                volume: 100
            }
